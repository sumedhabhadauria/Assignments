...
def extract_feature(uploaded_image):
...
def search_products(feature_vector, top_k=TOP_K):
...
if not uploaded_file:
    ...
    <div style="text-align:center;padding:72px 20px;color:#6B7A99;">
      ...
      <div style="font-size:.82rem;">Supports apparel, footwear, accessories and more.</div>
    ...
    for col, prod in zip(cols, row):
        with col:
            ...
            <div class="rcard-body">
              <div class="rcard-rank">Rank #{rank}</div>
